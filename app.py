...
if st.button("🔍 Predict Resale Price"):
    # Match exact order expected by the model
    # Index order: [latitude, longitude, closest_mrt_dist, cbd_dist, floor_area_sqm,
    #               lease_commence_date, year, ?, remaining_lease_years, storey_mid]
